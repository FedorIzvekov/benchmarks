...
public class Log4j2Logging {
    ...
    public void log4j2InfoPlaceholder(Data data) {
        data.log4j2.info(data.placeholder, UUID.randomUUID(), data.messages[0], data.messages[1], data.messages[2], data.messages[3]);
    }
    ...
    public void log4j2ErrorPlaceholder(Data data) {
        data.log4j2.error(data.placeholder, UUID.randomUUID(), data.messages[0], data.messages[1], data.messages[2], data.messages[3]);
    }
    ...
    public static class Data {
        ...
        @Setup
        public void setup() {
            slf4j = LoggerFactory.getLogger(Log4j2Logging.class);
            log4j2 = LogManager.getLogger(Log4j2Logging.class);
